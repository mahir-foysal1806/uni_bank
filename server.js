...
// Only legitimate, indexable, non-duplicate public pages.
// Admin pages (/admin/login, /admin/moderation), API routes, and the
// currently-placeholder /notes, /books and /syllabus pages (which are
// marked noindex until they have real content) are intentionally
// excluded. See Phase 8 notes if/when a custom domain replaces this URL.
res.send(
...
"</url>" +
"<url>" +
"<loc>https://uni-bank-1.onrender.com/upload</loc>" +
"<changefreq>monthly</changefreq>" +
"<priority>0.5</priority>" +
"</url>" +
"<url>" +
"<loc>https://uni-bank-1.onrender.com/ai</loc>" +
"<changefreq>monthly</changefreq>" +
